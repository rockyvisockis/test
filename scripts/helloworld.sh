...
yum -qq update 
DEBIAN_FRONTEND=noninteractive yum -qq install apt-utils -y > /dev/null 2>&1
DEBIAN_FRONTEND=noninteractive yum -qq install -y curl > /dev/null 2>&1
yum -qq install jq -y > /dev/null 2>&1
